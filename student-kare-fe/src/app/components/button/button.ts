...
export class Button {
  ...
  get classes(): string {
    const base = 'inline-flex items-center justify-center rounded-full transition-all duration-200 focus:outline-none active:scale-95 whitespace-nowrap';

    const sizes: Record<string, string> = {
      sm: 'px-4 h-10 text-sm font-semibold',
      md: 'px-[20px] h-[48px] text-[14px] font-normal leading-[48px]',
      lg: 'px-[25px] h-[48px] text-[14px] font-normal leading-[48px]',
    };

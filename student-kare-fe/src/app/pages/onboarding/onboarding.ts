...
interface Slide {
  ...
  bg_svg_Style: { width: string; height: string; top: string; opacity: string };
}
  ...
  slides: Slide[] = [
    {
      ...
      bg_svg_Style: { width: '423.33vw', height: '123.33vw', top: '128px', opacity: '0.19' },
    },
    {
    ...
    },
    {
      ...
      bg_svg_Style: { width: '430.00vw', height: '121.79vw', top: '136px', opacity: '0.19' },
    },
  ];

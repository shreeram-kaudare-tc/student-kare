...
interface Slide {
  ...
  bg_svg_Style: { width: string; height: string; top: string; opacity: string; background: string };
}
  ...
  slides: Slide[] = [
    {
      ...
      bg_svg_Style: { width: '423.33vw', height: '123.33vw', top: '128px', opacity: '0.19', background: 'linear-gradient(0deg, #3E63DD, #3E63DD), linear-gradient(90deg, #6B61FD 1%, #4E75F4 32.5%, #8060FF 90%)' },
    },
    {
    ...
    },
    {
      ...
      bg_svg_Style: { width: '430.00vw', height: '121.79vw', top: '136px', opacity: '0.19', background: 'linear-gradient(0deg, #3E63DD, #3E63DD), linear-gradient(90deg, #6B61FD 1%, #4E75F4 32.5%, #8060FF 90%)' },
    },
  ];
